...
namespace SuperAdventure
{
    public partial class TradingScreen : Form
    {
        ...
        {
            // The first column of a datagridview has a ColumnIndex of 0.
            ...
            // So, if the player clicked the button column, sell an item from that row.
            if (e.ColumnIndex == 4)
            {
                // This gets the ID value of the item, from the hidden 1st column
                // Remember, ColumnIndex 0 is for the first column.
