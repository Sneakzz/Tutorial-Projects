    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                // If the user typed a blank line, loop back and wait for input again
                ...
                // If the user typed something, determine what to do
            ...
            else if (input.Contains("attack"))
            {
                ...
                else
                {
                    if (_player.CurrentWeapon == null)
                    {
                        ...
                        // (or 'null', if the player does not have any weapons)
