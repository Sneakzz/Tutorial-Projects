...
namespace Engine
{
    public static class World
    {
        ...
        public const int ITEM_ID_OP_TESTWEAPON = 11;
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new Weapon(ITEM_ID_OP_TESTWEAPON, "OP sword", "OP swords", 75, 100, 150));
        ...
        private static void PopulateQuests()
        {
            Quest clearAlchemistGarden =
                new Quest(QUEST_ID_CLEAR_ALCHEMIST_GARDEN, "Clear the alchemist's garden",
            ...
            clearFarmersField.QuestCompletionItems.Add(
        ...
        private static void PopulateLocations()
        {
            ...
            Location alchemistGarden = new Location(LOCATION_ID_ALCHEMISTS_GARDEN,
                "Alchemist's garden",
                "Many plants are growing here.");
            alchemistGarden.AddMonster(MONSTER_ID_RAT, 100);
