...
namespace CSharpTut6
{
    class Animal
    {
        ...
        // Private fields can only be accessed by methods in the class and
        // they are not accessible by subclasses.
        ...
        // You can define read-only fields that are set at runtime in constructors,
        // but then can't be changed.
        ...
        public Animal(string name, string sound)
        {
            ...
            // Define the read-only property value which is the same for all Animals
        ...
        public void SetName(string name)
        {
            ...
            {
                // We have this duplicated code because everything isn't a property
                this.name = "No Name";
        ...
        // You can have the getters and setters generated for you like this
        // and also set the default value
