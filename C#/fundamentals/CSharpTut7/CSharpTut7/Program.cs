...
namespace CSharpTut7
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // The problem is that if you call a function in Animal it won't call
            // the overridden method in Dog unless the method that might be
            // overridden is marked with the keyword "virtual"
            spot.MakeSound();

            // This is an example of how Polymorphism allows a subclass to override a method
            // in the super class and even if the subclass is defined as the super class type
            // the correct method will still be called.
