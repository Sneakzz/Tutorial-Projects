...
namespace CSharpTutD
{
    class Program
    {
        ...
        // Changes made to those values do not affect the variables outside of the method
        ...
        // ----- PASS BY REFERENCE -----
        // If a variable is passed by reference, changes to its value in the method
        // affect it outside of the method
        ...
        // ----- METHOD OVERLOADING -----
        static double GetSum(int x = 1, int y = 1)
        {
            return x + y;
        }
