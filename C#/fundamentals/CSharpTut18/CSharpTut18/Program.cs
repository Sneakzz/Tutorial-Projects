...
namespace CSharpTut18
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // XmlSerialize writes object data as XML
            XmlSerializer serializer = new XmlSerializer(typeof(Animal));
            using (TextWriter tw = new StreamWriter(@"C:\Users\Kenny\C#Data\bowser.xml"))
            {
            ...
            TextReader reader = new StreamReader(@"C:\Users\Kenny\C#Data\bowser.xml");
            ...
            using (Stream fs = new FileStream(@"C:\Users\Kenny\C#Data\animals.xml",
            ...
            using (FileStream fs2 = File.OpenRead(@"C:\Users\Kenny\C#Data\animals.xml"))
            {
