...
namespace CSharpTut5
{
    class Animal
    {
        ...
        // public means it can be directly changed after an object has been created
        public string name;
        public string sound;

        // A constructor sets default values for fields when an object is created.
        // This is the default constructor if no parameters are set
        public Animal()
        {
            name = "No Name";
            sound = "No Sound";
        ...
        // You can create additional constructors but since we are defining defaults
        // we don't have to.
        public Animal(string name = "No Name")
        {
            // This refers to this objects name instead of the name passed into the constructor
            this.name = name;
            this.sound = "No Sound";
            numOfAnimals++;
        }
