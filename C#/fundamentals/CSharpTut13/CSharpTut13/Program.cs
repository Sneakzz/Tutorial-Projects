...
namespace CSharpTut13
{
    // This will cover multiple functions you can use to work with lists
    // of data including Lambda, Where, ToList, Select, Zip, Aggregate and Average
    ...
    class Program
    {
        ...
        {
            // Like previously with predicates, Lambda expressions allow you to
            // use anonymous methods that define the input parameters on the left
            ...
            // Here we'll search through a list to find all the even numbers
            ...
            // Find the number of heads and tails in a list
            // 1 = H, 2 = T
            ...
            // ---------- AGGREGATE ----------
            // Aggregate performs an operation on each item in a list
            // and carries the results forward.
            ...
            // ---------- DISTINCT ----------
            // Eleminates duplicates from a list
            ...
            // ---------- EXCEPT ----------
            // Receives 2 lists and returns values not found in the second list
