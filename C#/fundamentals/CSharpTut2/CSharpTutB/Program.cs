...
namespace CSharpTutB
{
    class Program
    {
        ...
        {
            // ----- IMPLICIT TYPING -----
            // You can use var to have C# figure out the data type.
            ...
            // ----- ARRAYS -----
            // Arrays are just boxes inside of a bigger box that can contain
            // many values of the same data type.
            // Each item is assigned a key starting at 0 and incrementing up from there.
            ...
            // When you define an array like arrName[5] you are saying
            // you want to create boxes stacked vertically

            // If you define arrName[2,2] you are saying you want to have
            // 2 rows high and 2 across
            ...
            // An array like arrName[2,2,3] would be like a stack
            // of 3 spread sheets with 2 rows and 2 columns worth of data on each page
            ...
            // FindAll returns an array with all values that match
            // FindIndex returns the index of the match

            // ----- STRINGBUILDER -----
            // Each time you change a string you are actually creating a new string
            // which  is inefficient when you are working large blocks of text.
            // StringBuilders actually change the text rather then make a copy

            // Create a StringBuilder with a default size of 16 characters,
            // but it grows automatically
            ...
            // ----- CASTING -----
            // If you want to to cast from one type to another
            long num1 = 1234;
            int num2 = (int)num1;
