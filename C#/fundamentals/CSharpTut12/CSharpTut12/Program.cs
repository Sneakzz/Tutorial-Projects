...
namespace CSharpTut12
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // You define the data type when defining the generic.
            ...
            // You can also use Stack<T>, Queue<T>, Dictionary<TKey, TValue>

            // Generic methods
            // You can use the type parameter <int> if it can be inferred from
            // the parameters passed (Can't do this if there are no parameters).
            int x = 5, y = 4;
            ...
            // Delegates allow you to reference methods inside a delegate object.
            // The delegate object can then be passed to other methods that can call
            // the methods assigned to the delegate.
            // It can also stack methods that are called in the specific order.
        ...
        public struct Rectangle<T>
        {
            ...
            {
                double dblWidth = Convert.ToDouble(this.Width);
                double dblLength = Convert.ToDouble(this.Length);
                return string.Format($"{this.Width} * {this.Length} = {dblWidth * dblLength}");
            }
        }

        // Declare a delegate type that performs arithmetic.
        // It defines the return type and the types for attributes.
