...
namespace CSharpTutA.cs
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // In my case the "€" sign isn't displayed correctly without setting
            // the outputEncoding to UTF8
            ...
            // Accepts input up until a newline, but it is here to keep the
            // console open after output
            // Read() accepts a single character
            Console.ReadLine();
        }
